...
<AppShell>
	...
	<div class="mt-2" />
	<slot />
	<svelte:fragment slot="pageFooter"><div class="bg-primary-400 p-2 mt-14 text-center text-surface-50 dark:bg-purple-900">&copy; Copyright  {date.getFullYear()}, Nu tre sa fieFagito</div></svelte:fragment>
</AppShell>
