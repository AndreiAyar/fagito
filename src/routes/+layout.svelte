...
<AppShell>
	...
	<div class="mt-2" />
	<slot />
	<svelte:fragment slot="pageFooter"><div class="bg-primary-400 p-2 mt-14 text-center text-surface-50 dark:bg-purple-900">&copy;!!!! Development {date.getFullYear()}, F!!!agito</div></svelte:fragment>
</AppShell>
